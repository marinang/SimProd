# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/12245402.py generated: Fri, 03 Nov 2017 08:48:39
#
# Event Type: 12245402
#
# ASCII decay Descriptor: [B+ ==> K+ ([J/psi(1S), psi(2S), X(3872)] => mu+ mu-) (eta => pi+ pi- pi0)]cc
#
from Configurables import Generation
Generation().EventType = 12245402
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_JpsietaK,mm,pipipi=TightCuts.dec"
...
tightCut.Decay     = '[ B+  ==>  ^K+ ^( (J/psi(1S) | psi(2S)) => ^mu+ ^mu-) ^(eta => ^pi+ ^pi- ^pi0) ]CC'
tightCut.Cuts      =    {
    'gamma'               : ' goodGamma ' ,
    '[mu+]cc'             : ' goodMuon  ' , 
    '[K+]cc'              : ' goodKaon  ' ,
