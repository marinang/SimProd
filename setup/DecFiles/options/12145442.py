# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/12145442.py generated: Fri, 03 Nov 2017 08:48:36
#
# Event Type: 12145442
#
# ASCII decay Descriptor: [B+ => K+ (psi(2S) => (J/psi(1S) => mu+ mu-) pi+ pi- ) (eta -> gamma gamma)]cc
#
from Configurables import Generation
Generation().EventType = 12145442
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_psi2SetaK,Jpsipipi,mm,gg=TightCuts.dec"
...
tightCut.Decay     = '[ B+  =>  ^K+ ( psi(2S) => ^( J/psi(1S) => ^mu+ ^mu-) ^pi+ ^pi-) ^(eta -> ^gamma ^gamma) ]CC'
tightCut.Cuts      =    {
    'gamma'     : ' goodGamma ' ,
    '[mu+]cc'   : ' goodMuon  ' , 
    '[K+]cc'    : ' goodKaon  ' ,
