# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/43900083.py generated: Fri, 03 Nov 2017 08:48:36
#
# Event Type: 43900083
#
# ASCII decay Descriptor: pp->(  H_20 -> ( H_30 -> d anti-d ) ( H_30 -> d anti-d) )
#
from Configurables import Generation
Generation().EventType = 43900083
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Higgs_AA,dddd=mH125GeV,mA3GeV,tA10ps,HidValley.dec"
Generation().Special.CutTool = ""
Generation().FullGenEventCutTool = "LoKi::FullGenEventCut/FourTracksFromHVPionInAcceptance"
from Configurables import LHCb__ParticlePropertySvc
LHCb__ParticlePropertySvc().Particles = [ "H_20 88 35 0.0 125.0 1.65e-22 Higgs'0 35 4.0e-03" , "H_30 89 36 0.0  3.0 1.0e-11      A0 36 0.0e+00" ]
