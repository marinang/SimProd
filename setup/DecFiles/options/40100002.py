# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/40100002.py generated: Fri, 03 Nov 2017 08:48:40
#
# Event Type: 40100002
#
# ASCII decay Descriptor: (A0 -> tau- tau+)
#
from Configurables import Generation
Generation().EventType = 40100002
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/A1_tautau,mA=10GeV,tA=90ps.dec"
...
tracksInAcc.Preambulo += [
    ...
    , "isA1           = ( 'H_30' == GID )"
    , "isGoodDaughterTau = ( ( GTHETA < 400.0*mrad ) & ( 'tau+' == GABSID ) )"
    , "isGoodA1 = ( isA1 & ( GNINTREE( isGoodDaughterTau, 4 ) >1 ) )"
    ]
