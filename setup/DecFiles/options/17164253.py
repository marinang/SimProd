# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/17164253.py generated: Fri, 03 Nov 2017 08:48:41
#
# Event Type: 17164253
#
# ASCII decay Descriptor: [B_s1(L)0 -> (B_s0 -> (D_s- -> K+ K- pi-) pi+) gamma]cc
#
from Configurables import Generation
Generation().EventType = 17164253
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bsprime1_Bsgamma,Dspi,KKpi=TightCut.dec"
...
tightCut.Decay     = '[B_s1(L)0 => (B_s0 => (D_s- => ^K+ ^K- ^pi-) ^pi+) ^gamma]CC'
tightCut.Preambulo += [
