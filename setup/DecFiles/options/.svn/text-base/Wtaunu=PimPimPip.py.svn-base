# Pythia options for W->taunu 42320002
...
Generation().Special.PythiaProduction.Commands += [ 
    ...
    "pydat3 mdme 208 1 1",
    "pydat3 mdme 209 1 0",
    # Allow only tau decays with three charged pions.
    "pydat3 mdme 89  1 0",
    "pydat3 mdme 90  1 0",
    "pydat3 mdme 91  1 0", 
    "pydat3 mdme 92  1 0", 
    ...
    "pydat3 mdme 141 1 0",
    "pydat3 mdme 142 1 0"
    # Allow only neutral rho decays with two charged pions.
    "pydat3 mdme 556 1 1",
    "pydat3 mdme 557 1 0",
    "pydat3 mdme 558 1 0",
    "pydat3 mdme 559 1 0",
...
Generation().Special.PythiaHiggsType.MotherOfLepton = [ "W+" ]
