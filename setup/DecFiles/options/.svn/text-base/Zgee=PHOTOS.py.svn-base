# Pythia options for Z/r*->ee 42122002 with invariant mass cut of 40GeV
...
Generation().Special.Pythia8Production.Commands += [ "PartonLevel:FSR=off",
                                                     ...
                                                     "23:onIfMatch = 11 -11" # turn it on for the decay to electron final state only
                                                     ]
