# Pythia options for Z/r*->tautaujet 42100021 with invariant mass cut of 40GeV
...
Generation().Special.Pythia8Production.Commands += [ "SpaceShower:rapidityOrder = off", #pT ordering!
