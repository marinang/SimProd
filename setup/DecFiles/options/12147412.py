# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/12147412.py generated: Fri, 03 Nov 2017 08:48:42
#
# Event Type: 12147412
#
# ASCII decay Descriptor: [B+ => K+ (psi(2S) => (J/psi(1S) => mu+ mu-) pi+ pi- ) (eta_prime => pi+ pi- (eta -> gamma gamma))]cc
#
from Configurables import Generation
Generation().EventType = 12147412
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_psi2SetapK,Jpsipipi,mm,pipieta,gg=TightCuts.dec"
...
tightCut.Decay     = '[ B+  =>  ^K+ ( psi(2S) => ^( J/psi(1S) => ^mu+ ^mu-) ^pi+ ^pi-) ^(eta_prime => ^pi+ ^pi- (eta -> ^gamma ^gamma)) ]CC'
tightCut.Cuts      =    {
    'gamma'               : ' goodGamma ' ,
    '[mu+]cc'             : ' goodMuon  ' , 
    '[K+]cc'              : ' goodKaon  ' , 
