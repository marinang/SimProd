# file /home/marinang/GaussDev_v49r3/Gen/DecFiles/options/12245412.py generated: Fri, 03 Nov 2017 08:48:41
#
# Event Type: 12245412
#
# ASCII decay Descriptor: [B+ => K+ ([J/psi(1S), psi(2S)] => mu+ mu-) (eta_prime => pi+ pi- (eta -> gamma gamma))]cc
#
from Configurables import Generation
Generation().EventType = 12245412
...
ToolSvc().EvtGenDecay.UserDecayFile = "$DECFILESROOT/dkfiles/Bu_JpsietapK,mm,pipieta,gg=TightCuts.dec"
...
tightCut.Decay     = '[ B+  =>  ^K+ ^( Meson => ^mu+ ^mu-) ^(eta_prime => ^pi+ ^pi- (eta -> ^gamma ^gamma)) ]CC'
tightCut.Cuts      =    {
    'gamma'               : ' goodGamma ' ,
    '[mu+]cc'             : ' goodMuon  ' , 
    '[K+]cc'              : ' goodKaon  ' , 
