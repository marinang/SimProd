...
#
#	batchoptions = {"basedir": options['basedir'], "subdir": options['subdir'], "jobname": options['jobname'], "command": command, 
#					"nfreenodes": options['nfreenodes'], "cpu": options['cpu'], "time": options['time'], "unique": True, 
